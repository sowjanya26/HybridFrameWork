...
public class TestB2 {
	...
	public void testB2(Hashtable<String, String> data) throws InvalidFormatException, IOException{
		ExcelReader excel = new ExcelReader(constants.SUITE2_XL_PATH);
		commonUtils.checkExecution("Suite2", this.getClass().getSimpleName(), data.get(constants.TEST_CASE_RUN_MODE), excel);
